...
component displayname="browserlesscfc"  {
    ...
    /**
    * @docs https://chrome.browserless.io/docs/#/Browser%20API/post_screenshot
    ...
    */
    public struct function screenshot( any options = {}, struct flags = {} ) {
      ...
      if( isSimpleValue( arguments.options ) ){
        payload = {
          'url': arguments.options
        }
      } else if( isObject( arguments.options ) ){
        payload = arguments.options.build();
      } else {
